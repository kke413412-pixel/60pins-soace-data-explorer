...
const quizData = [
    {
        question: "哪一个时间的温度最高？",
        options: ["10:00", "10:20", "10:40", "11:00"],
        correct: "10:20"
    },
    {
        question: "最低温度是多少？",
    ...
    quizData.forEach((item, index) => {
        ...
        item.options.forEach(option => {
            ...
            btn.addEventListener("click", function() {
                ...
                handleAnswer(index, option, this);
            });
...
function handleAnswer(index, selected, button) {
    ...
    if (selected === question.correct) {
        ...
        feedback.textContent = `❌ 答案不正确，正确答案是 ${question.correct}`;
...
function updateResultDisplay() {
    ...
    resultDiv.textContent = `你的得分：${quizScore} / ${total}`;
}
